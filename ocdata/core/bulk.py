...
def is_2D_slab_reasonable(struct: pymatgen.core.structure.Structure):
    """
...
def flip_struct(struct: pymatgen.core.structure.Structure):
    """
    ...
    Returns
    -------
    flipped_struct: pymatgen.core.structure.Structure
...
def is_structure_invertible(struct: pymatgen.core.structure.Structure):
    """
    This function figures out whether or not an `pymatgen.core.structure.Structure`
